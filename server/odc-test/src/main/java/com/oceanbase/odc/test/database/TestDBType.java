...
public enum TestDBType {
    ...
    OB_MYSQL("4.1.0.2", "odc.ob.default.mysql.commandline", "odc.ob.default.mysql.sysUsername",
            "odc.ob.default.mysql.sysPassword"),
    OB_ORACLE("4.1.0.2", "odc.ob.default.oracle.commandline", "odc.ob.default.mysql.sysUsername",
            "odc.ob.default.mysql.sysPassword"),
